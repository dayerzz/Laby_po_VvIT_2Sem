...
let virtual-env = "C:\Users\comb1nator\Desktop\Вуз\Введение в информационные технологии\4 лабораторная работа\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Users\comb1nator\Desktop\Вуз\Введение в информационные технологии\4 лабораторная работа\venv\Scripts\deactivate.nu"
