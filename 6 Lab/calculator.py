...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_third.addWidget(self.b_00)

        self.b_000 = QPushButton("000", self)
        self.hbox_third.addWidget(self.b_000)
        ...
        self.hbox_fourth.addWidget(self.b_multi)
        ...
        self.hbox_fifth.addWidget(self.b_sqrt)
        ...
        self.b_000.clicked.connect(lambda: self._button("000"))
        self.b_point.clicked.connect(lambda: self._button("."))
        self.b_del.clicked.connect(lambda: self._erase_text())
