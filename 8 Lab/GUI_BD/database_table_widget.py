...
class QDatabaseTableWidget(QTableWidget):
    ...
    def _append_row(self, **data):
        ...
        update_button = QTableWidgetButton("Обновить")
        ...
        delete_button = QTableWidgetButton("Удалить")
    ...
    def _append_mother_row(self):
        ...
        create_button = QTableWidgetButton("Создать")
    ...
    def _create_row(self, row_idx: int):
        try:
            ...
            QMessageBox.critical(self, "Операция невозможна", "Пожалуйста убедитесь, чтобы все колонки были заполнены")
            return
        ...
        try:
            ...
            QMessageBox.critical(
                self,
                "Операция невозможна",
                "Строка с указанным идентификатором уже существует. "
                "Пожалуйста, измените идентификатор на уникальный и повторите попытку",
            )
            return
    ...
    def _update_row(self, row_idx: int, row_id: int):
        ...
        try:
            ...
            QMessageBox.critical(
                self,
                "Операция невозможна",
                "Некорректное значение колонки/нок. "
                "Пожалуйста, измените значение/я на корректные и повторите попытку",
            )
        except ForeignKeyViolation:
            QMessageBox.critical(
                self,
                "Операция невозможна",
                "Нарушение foreign key ограничения. Пожалуйста, исправьте его и повторите попытку",
            )
